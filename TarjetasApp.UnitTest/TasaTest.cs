...
namespace TarjetasApp.UnitTest
{
    public class TasaTest
    {
        ...
        [Test]
        public void CalcularTasaPorcentual_Squa_CalculatesCorrectly()
        {
            //Arrange
        ...
        [Test]
        public void CalcularTasaPorcentual_Sco_CalculatesCorrectly()
        {
            //Arrange
        ...
        [Test]
        public void CalcularTasaPorcentual_Pere_CalculatesCorrectly()
        {
            //Arrange
